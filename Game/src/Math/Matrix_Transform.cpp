...
Mat4x4 Transform::Perspective(float fov, float aspect, float nearPlane, float farPlane) {
...
Mat4x4 Transform::Translate(const Mat4x4& mat, const Vector3f& pos) {
	Mat4x4 res;
...
Mat4x4 Transform::LookAt(Vector3f pos, Vector3f target, Vector3f tempUp) {
	Mat4x4 res;
